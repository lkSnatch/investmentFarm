...
public class GameplayScreen implements Screen {
  ...
  private Label cowAverageLabel;
  private Label cowCurrentLabel;
  private Label llamaAverageLabel;
  ...
  public GameplayScreen(InvestmentFarm game, InvestManager investManager) {
    ...
    cowIcon.setScale(0.8f);
    upperGroup.addActor(cowIcon);

    Label cowAmountTextLabel = new Label(investManager.cowUpdater.getCurrency().name + " = ", skin, "window");
...
//    cowTextLabel.sizeBy(2f);
    ...
    cowAverageLabel = new Label("23565360", skin, "window");
    cowAverageLabel.setColor(1f, 0.6f, 0f, 1f);
    upperGroup.addActor(cowAverageLabel);
    ...
    stage.addAction(new CurrentValue(investManager.cowUpdater, cowCurrentLabel, cowAverageLabel));

    Image llamaIcon = new Image(Assets.instance.playAsset.llama);
    upperGroup.addActor(llamaIcon);

    Label llamaTextLabel = new Label(investManager.llamaUpdater.getCurrency().name + " = ", skin, "window");
    llamaTextLabel.setColor(0f, 0.6f, 0f, 1f);
    llamaTextLabel.validate();
    upperGroup.addActor(llamaTextLabel);

    llamaAverageLabel = new Label("0", skin, "window");
    llamaAverageLabel.setColor(1f, 0.6f, 0f, 1f);
    upperGroup.addActor(llamaAverageLabel);
    ...
    stage.addAction(new CurrentValue(investManager.llamaUpdater, llamaCurrentLabel, llamaAverageLabel));
  ...
  public void dispose() {
    try {
      ...
      Gdx.app.log(TAG, "Couldn't dispose the stage", e);
    }
  }
